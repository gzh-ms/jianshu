...
export const setResetPasswordBy = str => ({
  type: actionTypes.SET_RESET_PASSWORD_BY,
  str
});
...
export const show_PasswordTip = () => ({
  type: actionTypes.SHOW__PASSWORD_TIP
});

export const change_PasswordFlag = () => ({
  type: actionTypes.CHANGE__PASSWORD_FLAG
});
